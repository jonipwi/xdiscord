      ...
      <div className="bg-white p-6 shadow-sm border-b">
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-lg mt-1">Choose a chat to start</p>
          </div>
      ...
      <div className="divide-y divide-gray-200">
        {isLoading ? (
          <div className="text-center py-16">
            ...
            <p className="text-2xl text-gray-500">Loading chats...</p>
          </div>
        ) : filteredChatList.length === 0 ? (
          <div className="text-center py-16">
            <MessageCircle size={64} className="mx-auto text-gray-300 mb-4" />
            <p className="text-2xl text-gray-500">No chats found</p>
            <p className="text-lg text-gray-400 mt-2">Try a different search</p>
          </div>
        ) : (
